...
- **--create_timeline**: Create timeline visualization grid
- **--timeline_cols**: Number of columns in timeline (default: 20)
- **--thumb_size**: Thumbnail size in pixels (width height, default: 120 80)
...
- **Grid Layout**: Organized chronologically with customizable columns
- **Color Coding**: Red borders for peaks, orange for valleys
- **Detailed Labels**: Frame number, timestamp, DISTS score, and type
- **Uniform Sizing**: All thumbnails resized to consistent dimensions
- **Legend**: Clear identification of peak vs valley keyframes
- **Statistics Header**: Total keyframes, peaks, and valleys count

#!/bin/bash
# Evaluation script for Advanced DSN (no motion)
# Advanced model with attention mechanisms but without motion features

set -e

echo "=========================================="
echo "Eval Advanced DSN (no motion)"
echo "=========================================="

# Configuration matching train_advanced_dsn.sh
CHECKPOINT_DIR="runs/dsn_advanced_v1_no_motion_100_samples_test_sakura"

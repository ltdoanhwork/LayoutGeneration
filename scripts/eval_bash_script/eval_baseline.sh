#!/bin/bash
# Evaluation script for Baseline DSN
# Simple baseline model without advanced features

set -e

echo "=========================================="
echo "Eval Baseline: Simple DSN"
echo "=========================================="

# Configuration matching train_baseline.sh
CHECKPOINT_DIR="runs/dsn_runs_baseline_100_samples/baseline_v1"
...
echo "  Model: Baseline (no motion, no anime attrs)"
echo ""

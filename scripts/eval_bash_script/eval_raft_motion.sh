#!/bin/bash
# Evaluation script for DSN with RAFT Motion
# Advanced DSN with RAFT optical flow motion features

set -e

echo "=========================================="
echo "Eval DSN with RAFT Motion"
echo "=========================================="

# Configuration matching train_dsn_with_raft_motion.sh
CHECKPOINT_DIR="runs/dsn_raft_motion"
...
OUTPUT_DIR="runs/eval_raft_motion"
DEVICE="cuda"
...
echo "  Model: Advanced + RAFT Motion (128-dim)"
echo ""

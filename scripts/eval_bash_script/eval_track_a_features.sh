#!/bin/bash
# Evaluation script for Track A: Anime-CLIP-IQA Features
# Concatenate Anime-CLIP-IQA attributes as input features

set -e

echo "=========================================="
echo "Eval Track A: Anime-CLIP-IQA Features"
echo "=========================================="

# Configuration matching train_track_a.sh
CHECKPOINT_DIR="runs/dsn_track_a_features"
...
OUTPUT_DIR="runs/eval_track_a_features"
DEVICE="cuda"

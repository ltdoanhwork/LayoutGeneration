#!/bin/bash
# Track C: Combined (Features + Rewards)

set -e

echo "=========================================="
echo "Training Track C: Combined Anime-CLIP-IQA"
echo "=========================================="

# Configuration
DATASET_ROOT="data/sakuga_dataset_100_samples"
SAVE_DIR="runs/dsn_track_c_combined"
LOG_DIR="runs/dsn_track_c_combined/logs"
EPOCHS=20
DEVICE="cuda"

# Validation
VAL_VIDEOS_DIR="/home/serverai/ltdoanh/LayoutGeneration/data/samples/Sakuga_test"
VAL_OUTPUT_DIR="runs/dsn_track_c_combined/val_runs"

#!/bin/bash
# Track B: Reward only (Anime-CLIP-IQA based rewards)

set -e

echo "=========================================="
echo "Training Track B: Anime-CLIP-IQA Rewards"
echo "=========================================="

# Configuration
DATASET_ROOT="data/sakuga_dataset_100_samples"
SAVE_DIR="runs/dsn_track_b_rewards"
LOG_DIR="runs/dsn_track_b_rewards/logs"
EPOCHS=20
DEVICE="cuda"
